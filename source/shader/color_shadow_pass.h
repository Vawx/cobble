...
/*
    ...
    Cmdline:
        sokol-shdc --input ../../../../content/shader/color_shadow_pass.glsl --output ../../../../source/shader/color_shadow_pass.h --slang glsl430:hlsl5:metal_macos

    Overview:
    =========
    Shader program: 'color_shadow_pass':
        Get shader desc: color_shadow_pass_shader_desc(sg_query_backend());
        Vertex Shader: vs
        Fragment Shader: fs
        Attributes:
            ATTR_color_shadow_pass_pos => 0
            ATTR_color_shadow_pass_texcoord0 => 1
    Bindings:
...
#endif
#endif
#define ATTR_color_shadow_pass_pos (0)
#define ATTR_color_shadow_pass_texcoord0 (1)
#define UB_vs_params (0)
#define IMG_diffuse_map (0)
...
/*
    ...
    layout(binding = 16) uniform sampler2D diffuse_map_diffuse_sampler;
    ...
    void main()
    {
        frag_color = texture(diffuse_map_diffuse_sampler, uv);
    }
...
static const uint8_t fs_source_glsl430[236] = {
    ...
    0x65,0x72,0x32,0x44,0x20,0x64,0x69,0x66,0x66,0x75,0x73,0x65,0x5f,0x6d,0x61,0x70,
    ...
    0x78,0x74,0x75,0x72,0x65,0x28,0x64,0x69,0x66,0x66,0x75,0x73,0x65,0x5f,0x6d,0x61,
    0x70,0x5f,0x64,0x69,0x66,0x66,0x75,0x73,0x65,0x5f,0x73,0x61,0x6d,0x70,0x6c,0x65,
...
/*
    ...
    void frag_main()
    {
        frag_color = diffuse_map.Sample(diffuse_sampler, uv);
    }
...
static const uint8_t fs_source_hlsl5[549] = {
    ...
    0x3e,0x20,0x64,0x69,0x66,0x66,0x75,0x73,0x65,0x5f,0x6d,0x61,0x70,0x20,0x3a,0x20,
    0x72,0x65,0x67,0x69,0x73,0x74,0x65,0x72,0x28,0x74,0x30,0x29,0x3b,0x0a,0x53,0x61,
    0x6d,0x70,0x6c,0x65,0x72,0x53,0x74,0x61,0x74,0x65,0x20,0x64,0x69,0x66,0x66,0x75,
    0x73,0x65,0x5f,0x73,0x61,0x6d,0x70,0x6c,0x65,0x72,0x20,0x3a,0x20,0x72,0x65,0x67,
    ...
    0x61,0x67,0x5f,0x63,0x6f,0x6c,0x6f,0x72,0x20,0x3d,0x20,0x64,0x69,0x66,0x66,0x75,
    0x73,0x65,0x5f,0x6d,0x61,0x70,0x2e,0x53,0x61,0x6d,0x70,0x6c,0x65,0x28,0x64,0x69,
...
/*
    ...
    fragment main0_out main0(main0_in in [[stage_in]], texture2d<float> diffuse_map [[texture(0)]], sampler diffuse_sampler [[sampler(0)]])
    {
        main0_out out = {};
        out.frag_color = diffuse_map.sample(diffuse_sampler, in.uv);
        return out;
    }

*/
static const uint8_t fs_source_metal_macos[431] = {
    0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,0x20,0x3c,0x6d,0x65,0x74,0x61,0x6c,0x5f,
    0x73,0x74,0x64,0x6c,0x69,0x62,0x3e,0x0a,0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,
    0x20,0x3c,0x73,0x69,0x6d,0x64,0x2f,0x73,0x69,0x6d,0x64,0x2e,0x68,0x3e,0x0a,0x0a,
    0x75,0x73,0x69,0x6e,0x67,0x20,0x6e,0x61,0x6d,0x65,0x73,0x70,0x61,0x63,0x65,0x20,
    ...
    0x72,0x65,0x32,0x64,0x3c,0x66,0x6c,0x6f,0x61,0x74,0x3e,0x20,0x64,0x69,0x66,0x66,
    0x75,0x73,0x65,0x5f,0x6d,0x61,0x70,0x20,0x5b,0x5b,0x74,0x65,0x78,0x74,0x75,0x72,
    ...
    0x65,0x28,0x64,0x69,0x66,0x66,0x75,0x73,0x65,0x5f,0x73,0x61,0x6d,0x70,0x6c,0x65,
...
static inline const sg_shader_desc* color_shadow_pass_shader_desc(sg_backend backend) {
    if (backend == SG_BACKEND_GLCORE) {
        ...
        if (!valid) {
            ...
            desc.image_sampler_pairs[0].glsl_name = "diffuse_map_diffuse_sampler";
            desc.label = "color_shadow_pass_shader";
        }
        return &desc;
    }
